		...
		struct platform_device *pdev, char *panel_cfg)
{
	...
	if (!l) {
		...
		if (!strncmp(panel_name, TXD_ILI9806C_480_800_4P0_P821A10_NAME,strnlen(TXD_ILI9806C_480_800_4P0_P821A10_NAME,PANEL_NAME_MAX_LEN)))
		    ...
		    (!strncmp(panel_name, TXD_ILI9488_320_480_3P5_P810D02_NAME,strnlen(TXD_ILI9488_320_480_3P5_P810D02_NAME,PANEL_NAME_MAX_LEN)))
			LcdPanleID=TXD_ILI9488_320_480_3P5_P810D02;      //zhoufan add for T792 20140520
		else
